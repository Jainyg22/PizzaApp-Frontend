...
function Home() {   
    return (
        ...
        <div>
            {/* Hero section */}
            <section
                className="flex flex-col-reverse items-center justify-center py-5 md:flex-row md:gap-7 bg-linear-to-r from-amber-50 to-orange-300
                "
            >
                <div className="w-4/6 ml-4 text-center md:w-2/6 md:text-left">
                    ...
                    <div className="flex justify-center text-4xl md:justify-normal">
                        ...
                        <h1 className="pb-5 font-bold text-transparent bg-linear-to-r from-orange-500 to-orange-400 bg-clip-text">
            ...
            {/* Services section */}
            <section
                className="py-4 mt-6 bg-linear-to-r from-amber-50 to-orange-300"
            >
                <div className="container flex flex-col md:flex-row">
                    ...
                    <div className="flex flex-col flex-wrap text-center lg:py-6 lg:w-1/2 lg:pl-12 lg:text-left">
                        ...
                        <div className="flex flex-col items-center lg:items-start">
                            <div>
                                <h2 className="mb-2 text-5xl font-extrabold text-transparent title-font bg-linear-to-r from-orange-600 to-orange-300 bg-clip-text">
                        ...
                        <div className="px-5 py-4 mx-auto">
                            ...
                            <div className="flex flex-wrap space-y-6 md:space-y-0">
                                ...
                                <div className="flex flex-col items-center text-center p-4 md:w-1/3">
                                    <div className="inline-flex items-center justify-center shrink-0 w-20 h-20 mb-5 bg-yellow-100 rounded-full">
                                        <img src={OrderFood} />
                                    </div>
                                    <div className="grow">
