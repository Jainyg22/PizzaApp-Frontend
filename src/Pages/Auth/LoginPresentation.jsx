        ...
        <section className="min-h-screen bg-linear-to-br from-amber-50 via-orange-50 to-orange-100 flex items-center justify-center px-4 py-12">
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 w-full max-w-5xl mx-auto">
                ...
                <div className="hidden md:flex md:w-1/2 flex-col items-center justify-center relative">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="869.99994" height="520.13854" viewBox="0 0 869.99994 520.13854" xmlnsXlink="http://www.w3.org/1999/xlink" className="relative z-10 w-full max-w-md drop-shadow-xl">
                        ...
                        <path d="M814.17958,522.54937H740.13271l.08911-.57617c.13306-.86133,13.19678-86.439,3.56177-114.436a11.813,11.813,0,0,1,6.06933-14.5835h.00025c13.77173-6.48535,40.20752-14.47119,62.52,4.90918a28.23448,28.23448,0,0,1,9.45947,23.396Z" transform="translate(-165.00003 -189.93073)" fill="#f9a826"/>
                        <path d="M754.35439,448.1812,721.01772,441.418l15.62622-37.02978a13.99723,13.99723,0,0,1,27.10571,6.99755Z" transform="translate(-165.00003 -189.93073)" fill="#f9a826"/>
                        <path d="M797.05043,460.73882l-2.00415-45.94141c-1.51977-8.63623,3.42408-16.80029,11.02735-18.13476,7.60547-1.32959,15.03174,4.66016,16.55835,13.35986l7.533,42.92774Z" transform="translate(-165.00003 -189.93073)" fill="#f9a826"/>
                ...
                <div className="w-full md:w-2/5 max-w-sm">
                    <div className="bg-white rounded-3xl shadow-xl shadow-orange-100/60 border border-orange-50 overflow-hidden">
                        ...
                        <div className="bg-linear-to-r from-orange-500 to-amber-400 px-8 py-6">
                            <span className="text-xs font-bold tracking-widest uppercase text-orange-100">Welcome back</span>
                            <h2 className="mt-1 text-2xl font-black text-white tracking-tight">Sign In</h2>
                            <p className="mt-0.5 text-orange-100 text-xs">Enter your credentials to continue</p>
                        </div>
                        ...
                        <form className="px-8 py-7 space-y-5">
                            <div>
                                ...
                                <input type="email" id="email" name="email" onChange={handleUserInput} required placeholder="john@example.com"
                            ...
                            <div>
                                ...
                                <input type="password" id="password" name="password" onChange={handleUserInput} required placeholder="Enter your password"
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-800 text-sm placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent focus:bg-white transition-all duration-200" />
                            </div>
                            ...
                            <p className="text-center text-xs text-gray-400">
                                ...
                                <Link to="/auth/signup" className="text-orange-500 font-bold hover:text-orange-600 transition-colors duration-150">Sign Up</Link>
                            </p>
                        </form>
                    </div>
                </div>
